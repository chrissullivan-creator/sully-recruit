            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="flex-1 overflow-auto">
                ...
                {activeTab === 'valid' && (valid.length === 0 ? (
                  ...
                  <table className="w-full text-xs"><thead className="bg-secondary sticky top-0"><tr>{['#','Title','Company','Location','Stage','Priority'].map(h => <th key={h} className="text-left px-4 py-2.5 text-muted-foreground font-medium uppercase tracking-wide">{h}</th>)}</tr></thead>
                ...
                {activeTab === 'issues' && (invalid.length === 0 ? (
                  ...
                  <table className="w-full text-xs"><thead className="bg-secondary sticky top-0"><tr>{['Row','Name','Issues'].map(h => <th key={h} className="text-left px-4 py-2.5 text-muted-foreground font-medium uppercase tracking-wide">{h}</th>)}</tr></thead>
