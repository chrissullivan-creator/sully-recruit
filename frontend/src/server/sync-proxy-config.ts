...
export async function applyProxyConfig(): Promise<{
...
// Helper `applyProxyConfig` is exported above and used by the
// Inngest function in src/inngest/functions/sync-proxy-config.ts.
// Both the daily 07:00 UTC cron and the on-demand event route through
// it.
