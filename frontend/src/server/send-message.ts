...
// Trigger.dev wrapper deleted in the cutover. Inngest's send-message
// function (frontend/src/inngest/functions/send-message.ts) owns this
// surface now — POST /api/trigger-send-message fires
// 'message/send-requested' which the function consumes.
