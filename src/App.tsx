      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/outreach/sequences" element={<ProtectedRoute><Campaigns category="outreach" /></ProtectedRoute>} />
            <Route path="/outreach/sequences/:id" element={<ProtectedRoute><SequenceDetail /></ProtectedRoute>} />
            <Route path="/marketing/sequences" element={<ProtectedRoute><Campaigns category="marketing" /></ProtectedRoute>} />
